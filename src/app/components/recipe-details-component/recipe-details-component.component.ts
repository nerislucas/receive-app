...
export class RecipeDetailsComponentComponent implements OnInit {
  recipe: Recipe;
  recipes: Recipe[];

  constructor(private activedRoute: ActivatedRoute, private location: Location) {
    this.recipes = [Recipe.recipeFromJson({
      ...
      'instructions': [
        ...
        {
          'instruction': 'Add the eggs, mashed bananas, buttermilk, and vanilla extract to ' +
            'the butter and sugar mixture and mix well. Fold in the flour mixture.',
          'photo': null
        },
        {
          'instruction': 'Grease a 20cm x 12.5cm/8in x 5in loaf tin and pour the cake mixture into the tin.',
          'photo': null
        },
        {
        ...
        {
          'instruction': 'Remove from the oven and cool in the tin for a few minutes, ' +
      ...
      'ingredients': [
        ...
        {
          'ingredient': 'carrot',
          'measure': '1 medium, diced 1/4in cubes'
        },
        {
